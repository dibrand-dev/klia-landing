...
import { Globe, Shield } from '@/components/ui/Icons'
...
const COLS = [
  ...
  {
    title: 'Soluciones',
    links: ['Para psicólogos', 'Para kinesiólogos', 'Para nutricionistas', 'Para equipos médicos'],
  },
  {
    title: 'Recursos',
    links: ['Centro de ayuda', 'Blog'],
  },
  {
    title: 'Empresa',
    links: ['Sobre Klia', 'Prensa', 'Privacidad', 'Términos'],
  },
]
      ...
      <div className="max-w-container mx-auto px-7 pt-24 pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_2.5fr] gap-20 pb-16 border-b" style={{ borderColor: 'rgba(255,255,255,.1)' }}>
          ...
          <div>
            ...
            <div className="flex gap-6 mt-8 text-xs" style={{ color: 'rgba(255,255,255,.55)' }}>
